...
class TemplateDataBinderTest {
  ...
  private val propRepo = mock<PropertyRepository>()
  ...
  @Test fun `project's name can bind properly`() {
    ...
    propRepo.stub {
      ...
      onGeneric { fetchProperty<String>(Stubs.project, ProjectProperty.NAME) } doReturn
        Property.instantiate(ProjectProperty.NAME, Stubs.project.id, "Project Name", Date()) as Property<String>
    }
