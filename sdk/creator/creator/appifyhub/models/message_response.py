...
class MessageResponse(BaseModel):
    ...
    materialized: StrictStr = Field(description="The materialized message with all variables replaced")
    __properties: ClassVar[List[str]] = ["template", "materialized"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "template": MessageTemplateResponse.from_dict(obj["template"]) if obj.get("template") is not None else None,
