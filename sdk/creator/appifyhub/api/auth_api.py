...
class AuthApi:
    ...
    def authenticate(
        self,
        creator_credentials_request: CreatorCredentialsRequest,
        ...
        :param creator_credentials_request: (required)
        :type creator_credentials_request: CreatorCredentialsRequest
        ...
        _param = self._authenticate_serialize(
            creator_credentials_request=creator_credentials_request,
    ...
    def _authenticate_serialize(
        ...
        if creator_credentials_request is not None:
            _body_params = creator_credentials_request
    ...
    def _create_api_key_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/creator/apikey',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
