...
class CreatorCredentialsRequest(BaseModel):
    """
    ...
    signature: StrictStr = Field(description="The secret signature of the creator, usually a plain-text password")
    origin: Optional[StrictStr] = Field(default=None, description="The origin of the request")
    __properties: ClassVar[List[str]] = ["universal_id", "signature", "origin"]
