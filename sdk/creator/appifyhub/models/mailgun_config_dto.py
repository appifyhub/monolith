...
class MailgunConfigDto(BaseModel):
    """
    Mailgun account configuration, primarily used for emails
    """ # noqa: E501
    api_key: StrictStr = Field(description="An active API key")
    domain: StrictStr = Field(description="A verified domain")
    sender_name: StrictStr = Field(description="The name of the default sender")
    sender_email: StrictStr = Field(description="The email of the default sender")
    __properties: ClassVar[List[str]] = ["api_key", "domain", "sender_name", "sender_email"]
