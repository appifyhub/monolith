...
class UserSignupRequest(BaseModel):
    ...
    """ # noqa: E501
    user_id: Optional[StrictStr] = Field(default=None, description="A unique user identifier within the project. Depending on the project configuration, it can be differently formatted or even auto-generated. ")
    raw_signature: StrictStr = Field(description="The secret signature of the user, usually a plain-text password")
    name: Optional[StrictStr] = Field(default=None, description="The name of the user")
    type: Optional[UserType] = None
    allows_spam: Optional[StrictBool] = Field(default=None, description="Whether the user allows spam or not")
    ...
    __properties: ClassVar[List[str]] = ["user_id", "raw_signature", "name", "type", "allows_spam", "contact", "contact_type", "birthday", "company", "language_tag", "signup_code"]
