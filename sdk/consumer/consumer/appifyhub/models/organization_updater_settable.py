...
class OrganizationUpdaterSettable(BaseModel):
    """
    A value wrapper for the organization property
    """ # noqa: E501
    value: OrganizationUpdaterDto
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": OrganizationUpdaterDto.from_dict(obj["value"]) if obj.get("value") is not None else None
        })
        return _obj
